...
from models.MambaCL.csm_triton import CrossScanTriton, CrossMergeTriton, CrossScanTriton1b1
...
def flops_selecbolitive_scan_ref(B=1, L=256, D=768, N=16, with_D=True, with_Z=False, with_Group=True, with_complex=False):
    """
    u: r(B D L)
    delta: r(B D L)
    A: r(D N)
